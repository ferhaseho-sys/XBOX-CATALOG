    ...
    <div className={`min-h-screen bg-background transition-colors ${darkMode ? 'dark' : ''}`}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h1 className="text-xl font-bold">Xbox Price Atlas</h1>
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="space-y-6">
          {/* Control de análisis del catálogo (sitemaps -> precios) */}
          <ScrapingControls
            progress={progress}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="games" className="space-y-4">
              <div className="flex gap-2">
                <Button
                  size="sm"
                  variant={catalogView === 'cards' ? 'default' : 'outline'}
            ...
            {/* Variantes / denominaciones por región */}
      ...
      <footer className="border-t bg-card mt-12">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <h3 className="font-semibold mb-2">Xbox Price Atlas</h3>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div>
              © 2024 Xbox Price Atlas - {isElectron ? 'Desktop' : 'Web'} Edition with Global Regional Database
            </div>
            <div className="flex items-center gap-4">
